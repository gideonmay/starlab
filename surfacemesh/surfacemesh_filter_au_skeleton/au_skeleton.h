...
public:
    ...
    virtual void applyFilter(Starlab::Document* document, RichParameterSet* parameters, StarlabDrawArea* drawArea);
    virtual void initParameters(Starlab::Document* , RichParameterSet*, StarlabDrawArea*);
